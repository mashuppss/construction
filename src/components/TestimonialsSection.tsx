...
const StarIcon = ({ filled }: { filled: boolean }) => (
  <svg className={`w-6 h-6 ${filled ? 'text-yellow-500' : 'text-gray-300 dark:text-gray-600'}`} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
...
const testimonialsData = [
  {
    ...
    location: "Orlando, FL",
    rating: 5,
    imageUrl: `${basePath}/assets/customers/1.png`
  },
  {
    ...
    rating: 5,
    imageUrl: `${basePath}/assets/customers/2.png`
  },
  {
    ...
    rating: 5,
    imageUrl: `${basePath}/assets/customers/3.png`
  },
  {
    ...
    rating: 4,
    imageUrl: `${basePath}/assets/customers/4.png`
  },
  {
    ...
    location: "Oviedo, FL",
    rating: 5,
    imageUrl: `${basePath}/assets/customers/5.png`
  },
  {
    ...
    rating: 5,
    imageUrl: `${basePath}/assets/customers/6.png`
  }
];
          ...
          {testimonialsData.map((testimonial, index) => (
            ...
            >
              ...
              <div className="relative flex-grow mt-4">
                ...
                <blockquote className="text-gray-700 dark:text-gray-300 italic text-base md:text-lg px-4 z-10">
                  {testimonial.quote}
                </blockquote>
